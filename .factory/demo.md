...
Open `https://rubric-comment-queue.sociobot.in/demo` or select **Try it with
sample data** on the first screen.

The demo contains three realistic writing excerpts. One response is ready, one
is being edited, and one has not started. The sample also includes a custom
teacher comment.
